#!/bin/bash
OUTPUT="csv/admin1.csv"
SOURCE_ADMIN="tsv/admin1CodesASCII.txt"
SOURCE="tmp/admin1.csv"
ALTERNATES="tmp/Alternates.csv"
COUNTRIES="tmp/countries.csv"
DEBUG="csv/debug_admin1.csv"

echo "country_iso_3166_a2;name_english;name_ascii;name_local;geoname_id;" > $OUTPUT
echo "country_iso_3166_a2;name_english;name_ascii;name_local;geoname_id;" > $DEBUG
...
grep -E "[A-Z]{2};(.*);.*;\1;[0-9]+;" $OUTPUT >> $DEBUG